...
export const generateImagePrompts = async () => {
    ...
    try {
        ...
        const imageWall = await fetch(`https://ik.imagekit.io/ilunarivanthesecond/imageWall.json?updatedAt=${Date.now()}`);
        ...
        Each image prompt must contain 250 to 300 words.
        ...
        40% Anime style (expressive characters, dynamic composition, stylized lighting)

        40% Watercolor style (soft textures, brush strokes, fluid color blending)

        20% Realism (natural lighting, believable environments, subtle physical details)

        Overall priority: Anime → Watercolor → Realism
        ...
        "imagePrompt": "(250–300 word detailed image prompt related to the dialogue and scene)"
        }
        ]
        ...
        Maintain 250–300 words per imagePrompt.
