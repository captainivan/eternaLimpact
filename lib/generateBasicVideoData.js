...
export const generateVideoBasicData = async (aimodel = "gemini-2.5-flash") => {
    ...
    try {
        ...
        // ✅ Fix 1 & 2: Properly fetch and parse the JSON
...
- And also you can select charcter from this field '${genre}' But If you have any better charcter idea from any better field
  you can go for it 
...
Length: 50-60 seconds narration.

The pacing must feel fast, cinematic
...
Sentences must punchy, and dramatic.
...
a viral YouTube Shorts storytelling experience.
        ...
        // ✅ Fix 3: Corrected fallback model logic (=== instead of !==)
        if (!response || !response.text) {
            if (aimodel === "gemini-2.5-flash-lite") {
