...
export const generateVideoBasicData = async (aimodel = "gemini-2.5-flash") => {
    ...
    try {
        ...
        Choose ONE person and prepare the story so it can be turned into a highly engaging 60–90 second cinematic narration.
        It must feel like a Netflix-level documentary condensed into 60–90 seconds.
